...
`${GOPATH}/src/github.com/davdjl/dbbeat`
...
```
git remote set-url origin https://github.com/davdjl/dbbeat
...
in the same directory with the name dbbeat.
...
```
mkdir -p ${GOPATH}/src/github.com/davdjl/dbbeat
git clone https://github.com/davdjl/dbbeat ${GOPATH}/src/github.com/davdjl/dbbeat
```
